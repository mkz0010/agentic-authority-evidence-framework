...
| `docs/en/status/v100-baseline-scope-and-promotion-decision.md` | v1.0.0 baseline scope and promotion decision | Initial v1.0.0 baseline scope and promotion decision note, distinguishing baseline candidates, stable guidance candidates, review-readiness areas, planning-only material, future work, and non-goals. |
| `docs/en/status/v100-promoted-artifact-candidate-inventory.md` | v1.0.0 promoted artifact candidate inventory | Inventory of v1.0.0 promotion candidates, distinguishing baseline candidates, stable guidance candidates, review-readiness candidates, planning-only and historical material, future work, and non-goals. |
| `docs/en/status/v100-planning-only-and-future-work-register.md` | v1.0.0 planning-only and future-work register | Register of v1.0.0 planning-only, historical, future-work, narrow-scope, and non-goal areas to prevent scope creep and preserve claim boundaries. |
| `docs/en/status/v100-claim-boundary-and-non-goal-checklist.md` | v1.0.0 claim-boundary and non-goal checklist | Checklist for v1.0.0 claim boundaries and non-goals, protecting release, baseline, validator, example, reconstruction, risk-owner decision, and public communication wording from overclaiming. |
| `docs/en/status/v100-baseline-scope-close-readiness-checklist.md` | v1.0.0 baseline scope close-readiness checklist | Close-readiness checklist for #351 v1.0.0 Baseline Scope and Promotion Decision, mapping completed artifacts to acceptance criteria while preserving baseline, release, and claim boundaries. |
| `docs/en/status/v100-control-catalog-readiness-review.md` | v1.0.0 control catalog readiness review | Reviews control catalog stability, control ID posture, promotion candidates, baseline update options, and relationships to schema, assessment, testing, examples, and validators. |
| `docs/en/status/v100-baseline-artifact-readiness-review.md` | v1.0.0 baseline artifact readiness review | Reviews relationships among the control catalog, evidence schema, assessment artifacts, testing procedures, examples, validators, mappings, entry points, and release notes. |
| `docs/en/status/v100-control-id-stability-note.md` | v1.0.0 control ID stability note | Preserves existing control IDs by default and treats any future ID change as a baseline-relevant change requiring separate review. |
| `docs/en/status/v100-baseline-update-decision-options.md` | v1.0.0 baseline update decision options | Compares active-baseline preservation, stable guidance promotion, targeted wording clarification, selected baseline artifact updates, broader baseline updates, and deferred baseline changes. |
| `docs/en/status/v100-control-catalog-and-baseline-artifact-close-readiness-checklist.md` | v1.0.0 control catalog and baseline artifact close-readiness checklist | Close-readiness checklist for #357 v1.0.0 Control Catalog and Baseline Artifact Readiness Review, mapping completed artifacts to acceptance criteria while preserving baseline, release, control ID, and claim boundaries. |
| `docs/en/status/v100-evidence-schema-readiness-review.md` | v1.0.0 evidence schema readiness review | Reviews action, authority, execution, non-execution, evidence gaps, operational reconstruction, risk-owner decision support, validator relationships, example relationships, schema update options, and claim boundaries. |
| `docs/en/status/v100-examples-and-fixtures-readiness-review.md` | v1.0.0 examples and fixtures readiness review | Reviews current examples, invalid examples, high-impact examples, approval/integrity examples, non-execution, denied/held/blocked actions, evidence gaps, reconstruction, risk-owner decision packages, prototype fixtures, validator relationships, and claim boundaries. |
| `docs/en/status/v100-validator-readiness-and-scope-review.md` | v1.0.0 validator readiness and scope review | Reviews current validators, validator boundaries, example and fixture relationships, assessment/testing relationships, external mapping relationships, false-assurance risks, future validator candidates, semantic validator posture, and claim boundaries. |
| `docs/en/status/v100-evidence-schema-example-validator-decision-options.md` | v1.0.0 evidence schema, example, and validator decision options | Compares artifact preservation, explanatory guidance, selected examples, scenario fixtures, targeted validators, schema clarification, selected schema fields, broader redesign, and semantic validator expansion. |
| `docs/en/status/v100-evidence-schema-examples-validator-close-readiness-checklist.md` | v1.0.0 evidence schema, examples, and validator close-readiness checklist | Close-readiness checklist for #363 v1.0.0 Evidence Schema, Examples, and Validator Readiness Review, mapping completed artifacts to acceptance criteria while preserving schema, example, fixture, validator, release, baseline, and claim boundaries. |
| `docs/en/status/v100-assessment-artifact-readiness-review.md` | v1.0.0 assessment artifact readiness review | Reviews assessment quick start, worksheets, profiles, evidence requests, reviewer judgment, pass/fail boundaries, relationships to evidence schema/examples/validators, assessment update options, and claim boundaries. |
| `docs/en/status/v100-testing-procedure-readiness-review.md` | v1.0.0 testing procedure readiness review | Reviews current testing procedures, control-specific testing expectations, pass/fail boundaries, evidence requests, reviewer judgment, relationships to assessment artifacts, evidence schema/examples/validators, testing procedure update options, and claim boundaries. |
| `docs/en/status/v100-assessment-testing-decision-options.md` | v1.0.0 assessment and testing decision options | Compares artifact preservation, explanatory guidance, targeted wording clarification, selected assessment/testing updates, targeted validators, broader redesign, pass/fail boundaries, evidence request posture, reviewer judgment, and claim boundaries. |
| `docs/en/status/v100-assessment-testing-close-readiness-checklist.md` | v1.0.0 assessment and testing close-readiness checklist | Close-readiness checklist for #369 v1.0.0 Assessment Artifact and Testing Procedure Readiness Review, mapping completed artifacts to acceptance criteria while preserving assessment, testing, release, baseline, pass/fail, evidence request, reviewer judgment, validator, and claim boundaries. |
| `docs/en/status/v100-implementation-adoption-guidance-readiness-review.md` | v1.0.0 implementation and adoption guidance readiness review | Reviews README and entry points, document navigation, implementer/operator/auditor/risk-owner/security/legal/researcher guidance, stable guidance candidates, planning-only/future-work areas, update options, and claim boundaries. |
| `docs/en/status/v100-adoption-entrypoint-and-navigation-readiness-review.md` | v1.0.0 adoption entrypoint and navigation readiness review | Reviews README and entry points, localized entry points, document map, status README, release notes, citation material, role-based navigation, examples/validators, assessment/testing navigation, update options, and claim boundaries. |
| `docs/en/status/v100-role-guidance-readiness-review.md` | v1.0.0 role guidance readiness review | Reviews implementer, operator, auditor/reviewer, evidence requester, risk owner, security architect, legal/compliance reviewer, researcher, maintainer, public communicator, cross-role responsibility boundaries, update options, and claim boundaries. |
| `docs/en/status/v100-implementation-adoption-guidance-decision-options.md` | v1.0.0 implementation/adoption guidance decision options | Compares preservation, explanatory navigation, targeted entrypoint/navigation updates, targeted role guidance clarification, release posture/citation/release-note deferral, role guidance gap register, public communication boundary note, broader redesign, and claim boundaries. |
| `docs/en/status/v100-implementation-adoption-guidance-close-readiness-checklist.md` | v1.0.0 implementation/adoption guidance close-readiness checklist | Close-readiness checklist for #374 v1.0.0 Implementation and Adoption Guidance Readiness Review, mapping completed artifacts to acceptance criteria while preserving guidance, entrypoint, navigation, role guidance, release, baseline, support-artifact, and claim boundaries. |
| `docs/en/status/v100-release-readiness-review.md` | v1.0.0 release readiness review | Reviews completed readiness-track inputs, release decision areas, active baseline wording, README/citation/release-note readiness, GitHub Release/tag readiness, public communication readiness, final release decision inputs, and claim boundaries. |
| `docs/en/status/v100-release-communication-boundary-note.md` | v1.0.0 release communication boundary note | Defines safe and unsafe release-facing wording for README, citation, release notes, GitHub Releases, public announcements, completed readiness tracks, support artifacts, external mappings, research positioning, and claim boundaries. |
| `docs/en/status/v100-readme-citation-release-note-update-options.md` | v1.0.0 README, citation, and release-note update options | Compares preservation, README wording options, citation options, release-note draft options, coordinated post-decision updates, early-update risks, active baseline wording options, and claim boundaries. |
| `docs/en/status/v100-final-release-decision-inputs.md` | v1.0.0 final release decision inputs | Defines the meaning of "final" as pre-release decision input rather than release action, and identifies required maintainer decisions for active baseline posture, README, citation, release notes, GitHub Release/tag, public announcement, release scope, blocker checks, and claim boundaries. |
| `docs/en/status/v100-release-readiness-close-readiness-checklist.md` | v1.0.0 release readiness close-readiness checklist | Close-readiness checklist for #380 v1.0.0 Release Readiness and Communication Planning, mapping completed artifacts to acceptance criteria while preserving release action, active baseline, README, citation, release-note, public announcement, support-artifact, and claim boundaries. |
| `docs/en/status/v100-release-action-or-deferral-decision-note.md` | v1.0.0 release action or deferral decision note | Compares explicit release action, release deferral, additional release-facing planning, baseline-updating release work, and non-goal release paths while preserving active baseline and claim boundaries. |
| `docs/en/status/v100-conservative-release-action-package-planning.md` | v1.0.0 conservative release action package planning | Selects the active-baseline-unchanged release path and defines release package components, release-note structure, README/citation/tag/GitHub Release decisions, validation expectations, #350 closure expectations, and claim boundaries. |
| `docs/en/status/post-v100-repository-and-roadmap-review.md` | post-v1.0.0 repository and roadmap review | Reviews release/tag state, issue and milestone cleanup, documentation navigation, active-baseline-unchanged wording, claim-boundary risk, historical/planning material clarity, and next-roadmap options. |
| `docs/en/status/post-v100-public-communication-and-readme-review.md` | post-v1.0.0 public communication and README review | Reviews active-baseline-unchanged communication risk, public-facing claim boundaries, safe wording patterns, README update options, and announcement timing risk. |
| `docs/en/status/post-v100-next-roadmap-options.md` | post-v1.0.0 next-roadmap options | Compares close-readiness, stabilization, v1.1.0 planning, baseline-update candidate review, public communication, implementation/adoption guidance, examples/fixtures/validators, research positioning, and AAEF-AI-VA alignment options. |
| `docs/en/status/post-v100-close-readiness-checklist.md` | post-v1.0.0 close-readiness checklist | Reviews release state, repository/roadmap state, README and public-entrypoint state, claim boundaries, external review response, follow-up posture, and closure recommendation for #388. |
| `docs/en/status/post-v100-implementation-guidance-priority-review.md` | post-v1.0.0 implementation guidance priority review | Non-normative planning review for implementation guidance priorities and future baseline-candidate planning. |
| `docs/en/status/post-v100-evidence-and-reviewer-guidance-review.md` | post-v1.0.0 evidence and reviewer guidance review | Clarifies what AAEF evidence and reviewer guidance may support, what it cannot establish by itself, and how to preserve evidence sufficiency, validator, audit, and legal sufficiency boundaries. |
| `docs/en/status/post-v100-baseline-candidate-promotion-model.md` | post-v1.0.0 baseline candidate promotion model | Defines conservative promotion stages, promotion criteria, non-promotion criteria, and active-baseline update boundaries for future baseline-candidate material. |
| `docs/en/status/post-v100-framework-gap-statement-planning.md` | post-v1.0.0 framework gap statement planning | Clarifies where AAEF complements external AI governance, security, identity, Zero Trust, and privileged-access concepts while preserving non-equivalence, non-certification, non-compliance, audit, and legal sufficiency boundaries. |
| `docs/en/status/post-v100-implementation-guidance-baseline-candidate-close-readiness-checklist.md` | post-v1.0.0 implementation guidance and baseline candidate close-readiness checklist | Reviews whether #395 is ready to close after implementation guidance priority review, evidence and reviewer guidance review, baseline candidate promotion model, and framework gap statement planning work. |
| `docs/en/status/post-v100-current-state-and-next-direction-review.md` | post-v1.0.0 current-state and next-direction review | Summarizes current release, active-baseline, completed post-v1.0.0 tracks, preserved boundaries, and next-direction options after #388 and #395. |
| `docs/en/status/post-v100-public-communication-refinement-review.md` | post-v1.0.0 public communication refinement review | Reviews external-reader wording, public gap statement options, README/overview clarity, active-baseline communication, external-framework relationship language, and claim-boundary safety. |
| `docs/en/status/post-v100-public-communication-refinement-close-readiness-checklist.md` | post-v1.0.0 public communication refinement close-readiness checklist | Reviews whether #403 is ready to close after the public communication refinement review and README / README.ja public-entrypoint wording update. |
| `docs/en/status/post-v100-decomposition-and-practical-package-boundary-review.md` | post-v1.0.0 decomposition and practical package boundary review | Defines AAEF Core, Profile, Practical Package, Applied Implementation, and External Strategy boundaries; identifies AI Agent Action Risk Review as a first practical package candidate; preserves active-baseline and claim boundaries. |
| `docs/en/status/post-v100-terminology-and-evidence-boundary-review.md` | post-v1.0.0 terminology and evidence boundary review | Documents terminology risk categories, evidence non-proof boundaries, evidence trust boundaries, model/runtime self-report limitations, compromised component limitations, validator interpretation boundaries, and human approval vs risk acceptance boundaries. |
| `docs/en/status/post-v100-what-aaef-evidence-does-not-prove.md` | post-v1.0.0 evidence non-proof boundary review | Clarifies that AAEF evidence supports review and reconstruction but does not establish legal proof, audit sufficiency, compliance sufficiency, correctness, readiness, risk acceptance, or external-framework equivalence. |
| `docs/en/status/post-v100-operational-action-boundary-demo-planning.md` | post-v1.0.0 operational action boundary demo planning | Plans a narrow AAEF main public static demo around a logistics/RPA shipment action boundary and separates static explanatory fixtures from a possible later minimal executable proof-of-concept. |
| `docs/en/status/post-v100-operational-action-validation-planning.md` | post-v1.0.0 operational action validation planning | Plans possible future static validation boundaries for the operational-action fixture family, including allowed structural consistency checks and explicit non-goals around conformance, certification, audit, legal, compliance, sufficiency, readiness, and external-framework equivalence. |
