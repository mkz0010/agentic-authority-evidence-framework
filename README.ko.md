...
**AAEF v0.5.0 Public Review Planning Release** 는 최신 공개 검토 planning release 입니다.

AAEF v0.5.0은 non-normative planning and design-clarification release 입니다. authority lifecycle, evidence integrity, approval quality 및 future v0.5.x work를 위한 planning models와 incorporation guidance를 추가합니다. AAEF v0.4.1은 control catalog, evidence schema, assessment artifacts 또는 testing procedures가 명시적으로 갱신되기 전까지 현재 control and assessment baseline으로 유지됩니다.

이전 v0.3.x, v0.2.x, v0.1.x releases 는 prior public review baselines 로 계속 참조할 수 있습니다.

AAEF v0.5.0에 포함된 주요 요소:
...
AAEF v0.5.0은 공개 검토 planning release 입니다. 인증 체계, 공식 표준, implementation conformance claim, audit opinion, compliance equivalence 또는 완전한 완화 주장을 의미하지 않습니다.
